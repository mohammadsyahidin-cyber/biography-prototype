...
import { Mic, Users, Flame, Compass, Plus, PenLine, BookOpen } from "lucide-react";
        ...
        <div style={{ padding: "8px 20px 24px" }}>
          ...
          <div className="flex items-center justify-between" style={{ marginBottom: 8 }}>
              ...
              <div className="flex items-center gap-3">
                ...
                <Link href={isEmpty ? "/settings" : "/members"} className="flex items-center justify-center" style={{ width: 36, height: 36, borderRadius: 18, backgroundColor: "var(--bg-muted)" }}>
